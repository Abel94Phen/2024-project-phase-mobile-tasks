...
import 'package:ecommerce_app/features/product/data/repositories/product_repository_implementation.dart';
  ...
  group('get current product test', () {
    runTestsOnline(() {
      test(
          ...
          () async {
        //arrange
        when(mockProductRemoteDataSource.getSingleProduct(testProductId))
            .thenAnswer((_) async => testProductModel);

        //act
        final result =
            await productRepositoryImpl.getSingleProduct(testProductId);
