...
class EcommerceApp {
  var productManagers = {
    'PM1': ProductManager([
      Product('Laptop',
          'A high-performance laptop with 16GB RAM and 512GB SSD.', 1200.00),
      Product(
    ...
    'PM2': ProductManager([
      Product('Gaming Console', 'Next-gen gaming console with 1TB storage.',
          499.99),
      ...
      Product('External Hard Drive', '2TB external hard drive with USB 3.0.',
          89.99),
      Product('Printer',
          'Wireless all-in-one printer with scanning and copying.', 129.99),
    ...
    'PM3': ProductManager([
      Product('VR Headset',
          'Virtual reality headset with immersive experience.', 299.99),
      ...
      Product(
          'Air Purifier', 'HEPA air purifier for clean indoor air.', 149.99),
    ]),
  };
  ...
  void addProduct() {
    ...
    productManagers[manager]?.addProduct(Product(name, description, price));
  }
